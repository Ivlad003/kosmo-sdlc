...
description: Sub-agent dispatched by /kosmo-sdlc:cycle for the implement phase. Plans against §6, implements requirements, runs the pipeline gate per requirement, returns a frontmatter delta with updated statuses and journal rows.
...
Follow the [/kosmo-sdlc:implement](../commands/implement.md) workflow:
